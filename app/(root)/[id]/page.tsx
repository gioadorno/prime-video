      ...
      {details && (
        <>
          <div className="max-w-lg md:max-w-4xl xl:max-w-7xl">
            <div className="bg-[#07192978] rounded-lg flex flex-col">
              ...
              <div className="flex items-center justify-center z-[1] border-t-[1px] border-white py-8">
                <article className="flex w-full flex-col items-start z-10 px-5 ">
                  ...
                  <div className="flex items-center w-full">
                    <div className="flex flex-col">
                      ...
                      <a
                        ...
                        className="text-slate-200 block text-sm md:text-lg tracking-tight hover:text-primary-color"
                      >
                        {details.homepage}
                      </a>
                    </div>
                  ...
                  <div className="flex flex-wrap items-center justify-center w-full">
                    <p className="text-white mt-10 w-full max-w-[95%]">
                      {details.overview}
                    </p>
                  </div>
                </article>
